...
class Aliment
{
     ...
     * @Assert\Length(min=3, max=15, minMessage="Le nom doit faire 3 caracteres minimum", maxMessage="Le nom doit faire 15 caracteres maximum")
     */
    private $nom;

    /**
     * @ORM\Column(type="float")
     * @Assert\Range(min=0.1, max=100, minMessage="Le prix doit 0.1  minimum", maxMessage="Le prix doit 100 maximum")
     */
    private $prix;
